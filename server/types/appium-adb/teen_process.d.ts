...
export class SubProcess extends EventEmitter {
	...
	start(
		startDetector?: ((stdout: string, stderr: string) => boolean) | number | null | undefined,
		detach?: boolean
	): Promise<void>;
	start(
		startDetector?: ((stdout: string, stderr: string) => boolean) | number | null | undefined,
	...
	addListener(event: 'lines-stdout', listener: (lines: string[]) => void): this;
	addListener(event: 'lines-stderr', listener: (lines: string[]) => void): this;
	addListener(event: 'stream-line', listener: (line: string) => void): this;
	emit(event: string | symbol, ...args: any[]): boolean;
	emit(event: 'exit', code: number | null, signal: NodeJS.Signals | null): boolean;
	emit(event: 'stop', code: number | null, signal: NodeJS.Signals | null): boolean;
	emit(event: 'end', code: number | null, signal: NodeJS.Signals | null): boolean;
	emit(event: 'die', code: number | null, signal: NodeJS.Signals | null): boolean;
	emit(event: 'output', stdout: string, stderr: string): this;
	emit(event: 'lines-stdout', lines: string[]): this;
	emit(event: 'lines-stderr', lines: string[]): this;
	emit(event: 'stream-line', line: string): this;
	on(event: string, listener: (...args: any[]) => void): this;
	on(event: 'exit', listener: (code: number | null, signal: NodeJS.Signals | null) => void): this;
	on(event: 'stop', listener: (code: number | null, signal: NodeJS.Signals | null) => void): this;
	on(event: 'end', listener: (code: number | null, signal: NodeJS.Signals | null) => void): this;
	on(event: 'die', listener: (code: number | null, signal: NodeJS.Signals | null) => void): this;
	on(event: 'output', listener: (stdout: string, stderr: string) => void): this;
	on(event: 'lines-stdout', listener: (lines: string[]) => void): this;
	on(event: 'lines-stderr', listener: (lines: string[]) => void): this;
	on(event: 'stream-line', listener: (line: string) => void): this;
	once(event: string, listener: (...args: any[]) => void): this;
	once(event: 'exit', listener: (code: number | null, signal: NodeJS.Signals | null) => void): this;
	once(event: 'stop', listener: (code: number | null, signal: NodeJS.Signals | null) => void): this;
	once(event: 'end', listener: (code: number | null, signal: NodeJS.Signals | null) => void): this;
	once(event: 'die', listener: (code: number | null, signal: NodeJS.Signals | null) => void): this;
	once(event: 'output', listener: (stdout: string, stderr: string) => void): this;
	once(event: 'lines-stdout', listener: (lines: string[]) => void): this;
	once(event: 'lines-stderr', listener: (lines: string[]) => void): this;
	...
	prependListener(event: 'lines-stdout', listener: (lines: string[]) => void): this;
	prependListener(event: 'lines-stderr', listener: (lines: string[]) => void): this;
	...
	prependOnceListener(event: 'lines-stdout', listener: (lines: string[]) => void): this;
	prependOnceListener(event: 'lines-stderr', listener: (lines: string[]) => void): this;
