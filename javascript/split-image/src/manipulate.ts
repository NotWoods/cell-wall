...
export type ResizeProps = 'width' | 'height';
export type CropProps = ResizeProps | 'x' | 'y';
...
export function resize(
  image: Jimp,
  { width, height }: Pick<CellInfo, ResizeProps>,
  query: ResizeOptions = {},
) {
...
export function crop(image: Jimp, cell: Pick<CellInfo, CropProps>) {
  return new Promise<Jimp>((resolve, reject) =>
