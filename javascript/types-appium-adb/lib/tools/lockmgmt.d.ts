...
interface LockMgmt {
	 ...
	 */
	verifyLockCredential(credential?: string | null | undefined): Promise<boolean>;
	 ...
	 */
	clearLockCredential(credential?: string | null | undefined): Promise<void>;
	...
	setLockCredential(
		...
		credential: string,
		oldcredential?: string | null | undefined
	): Promise<void>;
