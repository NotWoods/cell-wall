import { c as create_ssr_component, a as subscribe, b as add_attribute, e as escape, g as getContext, s as setContext, v as validate_component } from "./index-0b76d127.js";
import { n as navigating, T as TopBar, R as RemoteFrame } from "./TopBar-a3c8c5c4.js";
import { r as readable, d as derived } from "./index-441a7cba.js";
...
const _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  socket == null ? void 0 : socket.addEventListener("error", (event) => {
    console.error("RemoteSocket error", event);
    snackbarHostState.showSnackbar("Remote socket error");
  });
  socket == null ? void 0 : socket.addEventListener("open", (event) => console.info("RemoteSocket open", event));
  socket == null ? void 0 : socket.addEventListener("close", (event) => console.info("RemoteSocket close", event));
