import { g as getContext, c as create_ssr_component, a as subscribe, e as escape, b as add_attribute, v as validate_component } from "./index-07af9b00.js";
const getStores = () => {
...
const TopBar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<nav${add_attribute("class", className, 0)}><div class="${"top-bar flex flex-wrap gap-2 items-center max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-2"}">
		...
		${validate_component(TopBarItem, "TopBarItem").$$render($$result, { href: "/remote/presets" }, {}, {
    default: () => {
      return `Presets`;
    }
  })}
